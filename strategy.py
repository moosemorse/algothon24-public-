...
files = [
    ...
    {"path": "./release_3611.crypt", "password": "GMJVDf4WWzsV1hfL"},
    {"path": "./release_3675.crypt", "password": "PSI9bPh4aM3iQMuE"},
    {"path": "./release_3739.crypt", "password": "1vA9LaAZDTEKPePs"},
    {"path": "./release_3803.crypt", "password": "0n74wuaJ2wm8A4qC"},
    {"path": "./release_3867.crypt", "password": "mXTi0PZ5oL731Zqx"},
    {"path": "./release_3931.crypt", "password": "hjhMuDFZTCJEcI6q"},
    {"path": "./release_3995.crypt", "password": "uZwgENGlQ4m4nSz6"},
    {"path": "./release_4059.crypt", "password": "HkpYXpKituGernrk"},
]
...
portfolio_weights = pd.DataFrame({
    'Strategy': strategies,
    'Posterior Expected Return': posterior_returns.values,
